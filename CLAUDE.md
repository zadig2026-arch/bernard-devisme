...
**Studio navigation**: opening a rubric under its part of the site (Peinture, Sculpture…) shows a two-entry list — « Les œuvres » and « Titre, texte et groupes d'œuvres » — so the rubric's own form is reachable from where Bernard actually looks for it. « Modifier une rubrique » at the bottom of the menu is kept on purpose: he has just learned that path. The Studio keeps Sanity's default (white) theme: a custom paper/ink/sienna theme was written on 29/07 for his "everything is white, I can't tell where I am" remark, then dropped on 01/08 when he answered « je conserve l'affichage blanc » — don't re-theme the Studio without asking him first.
